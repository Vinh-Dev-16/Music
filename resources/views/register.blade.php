...
<body class="">
  ...
  <main class="main-content  mt-0">
    <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg" style="background-image: url('{{asset('https://images.hdqwalls.com/wallpapers/marshmello-concert-4k-tj.jpg')}}'); background-position: center;">
          ...
          <div class="card z-index-0">
            ...
            <div class="card-body">
              <form role="form" action="{{url('/do-register')}}" method="POST">
                @csrf
                <div class="mb-3">
                  <input type="text" class="form-control" placeholder="Tên đăng nhập" name="name" aria-label="Name">
                </div>
                @error('name')
                ...
                @enderror
                <div class="mb-3">
                  <input type="email" class="form-control" placeholder="Email của bạn" name="email" aria-label="Email">
                </div>
                @error('email')
                <div class="text-danger" style=" color:red">{{ $message }}</div>
                @enderror
                <div class="mb-3">
                  <input type="password" class="form-control" placeholder="Nhập password" name="password" aria-label="Password">
                </div>
                @error('password')
                <div class="text-danger" style=" color:red">{{ $message }}</div>
                @enderror
